...
export const DEFAULTS: Record<FurnitureType, Omit<Furniture, "id" | "x" | "y">> = {
  ...
  "salon-chair":   { type: "salon-chair",   name: "Barber Chair",  w: 64,  h: 84,  rotation: 0, fill: "#8B5CF6", stroke: "#4C1D95", opacity: 1, radius: 14 },
  "massage-bed":   { type: "massage-bed",   name: "Massage Bed",   w: 180, h: 70,  rotation: 0, fill: "#F9A8D4", stroke: "#9D174D", opacity: 1, radius: 14 },
  "cash-counter":  { type: "cash-counter",  name: "Cash Counter",  w: 140, h: 60,  rotation: 0, fill: "#C9A87C", stroke: "#1B1A1A", opacity: 1, radius: 4  },
  "shampoo-chair": { type: "shampoo-chair", name: "Wash Station",  w: 70,  h: 100, rotation: 0, fill: "#BAE6FD", stroke: "#0C4A6E", opacity: 1, radius: 16 },
